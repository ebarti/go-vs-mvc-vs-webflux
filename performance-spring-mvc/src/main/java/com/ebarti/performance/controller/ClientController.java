...
public class ClientController {
    ...
    public CompletableFuture<String> getUserUsingWebfluxWebclient(@RequestParam long id) {
    	return sendRequestWithApacheHttpClient(id);
    }    
    
    private CompletableFuture<String> sendRequestWithApacheHttpClient(long id) {
        ...
        HttpUriRequest request = new HttpGet("http://localhost:8081/product?id="+id);
